...
type SignupStep = 'details' | 'phone-verification' | 'role-selection';
...
export default function SignUp() {
  ...
  const [role, setRole] = useState<'sender' | 'carrier' | ''>('');
  ...
  // Step 1: Collect user details and create account
  ...
  const handleSendPhoneOTP = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const result = await verifyPhoneForExistingUser(formattedPhone);
  ...
  const handleVerifyPhoneOTP = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await completePhoneVerification(confirmationResult, otp);
  ...
  // Step 4: Select role and complete signup
  const handleSelectRole = async (selectedRole: 'sender' | 'carrier') => {
    setLoading(true);
    setError('');
            ...
            <>
                ...
                >
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Send parcels to others via train passengers</p>
                    </div>
                  </div>
                </div>
                ...
                >
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Carry parcels for others during your train journey</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-6">
                <Button
                  ...
                  onClick={() => role && handleSelectRole(role)}
                >
